...
//        cell.customImageView.kf.indicatorType = .activity  // Индикатор загрузки
//        cell.customImageView.kf.setImage(
//            with: URL(string: photo.largeImageURL),
//            placeholder: UIImage(named: "placeholder"), // Изображение-заглушка
//            options: [
//                .transition(.fade(1)),
//                .cacheOriginalImage
//            ])
...
//        print("[ImagesListViewController]: Ячейка настроена для \(photo.largeImageURL).")
//    }
//    
